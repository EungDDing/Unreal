...
void UMyGameInstance::Init()
{
	...
	UE_LOG(LogTemp, Log, TEXT("모든 학생의 이름 수 : %d"), AllStudentsName.Num());
	...
	UE_LOG(LogTemp, Log, TEXT("중복없는 학생의 이름 수 : %d"), AllUniqueNames.Num());
	...
	UE_LOG(LogTemp, Log, TEXT("이름에 따른 학생 멀티 맵의 레코드 수 : %d"), StudentsMapByName.Num());
